...
public class CieloEcommerce {
     ...
     * Query a Sale on Cielo by paymentId
     *
     * @param merchantOrderId The paymentId to be queried
     * @return The Sale with authorization, tid, etc. returned by Cielo.
     * @throws IOException
     * @throws CieloRequestException if anything gets wrong.
     * @see <a href=
     ...
     * @param serviceTaxAmount Amount of the authorization should be destined for the service
     *                         charge
     * @return The Sale with authorization, tid, etc. returned by Cielo.
     * @throws IOException
     * @throws CieloRequestException if anything gets wrong.
